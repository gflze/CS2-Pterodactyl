...
The CS2 image also has the option to configure the `gameinfo.gi` file for MetaMod automatically or inject a Metamod loader, which should be convenient for modded servers.
